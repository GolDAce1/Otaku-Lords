<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Otaku Lordss.aspx.cs" Inherits="Otaku_Lordss" %>


<html xmlns="http://www.w3.org/1999/xhtml">

<head>
    <title>Otaku Lords</title>
    <style>
        body {
            background-image: url("http://images6.fanpop.com/image/photos/35600000/Anime-Characters-anime-universe-35612327-4098-2304.jpg");
...
<body>
    <div id="mainarea" class="container text-center">
    </div>
    <div id="informationholder" class="pre-scrollable">
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="col-sm-6 ">
                <div class="well well-sm">
                    <h3>Otaku Lords
                        <img src="https://statsroyale.com/images/badges/16000026.png" height="50" /></h3>
                    <ul class="list-group">
                        <li class="list-group-item">Tag: #CVYQPJV</li>
                        ...
                        <li class="list-group-item">2nd in Command: Hood Boi / OptikTank</li>
                        <li class="list-group-item">Group Chat: Instagram
                            <img class="lineIcon" height="35" src="//www.brandchannel.com/wp-content/uploads/2016/05/instagram-new-logo-may-2016.jpg"></li>
                    </ul>
                </div>
            </div>
        </div>
